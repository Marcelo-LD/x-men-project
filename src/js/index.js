...
personagens.forEach((personagem) => {
    personagem.addEventListener('mouseenter', () => {
        ...
        // passo 2 - alterar a imagem do personagem grande
        alterarImagemDoPersonagemGrande(personagem, imagemPersonagemGrande);

        // passo 3 - alterar o nome do personagem grande
        alterarONomeDoPersonagemGrande(personagem);
...
function alterarONomeDoPersonagemGrande(personagem) {
    const nomePersonagem = document.getElementById('nome-personagem');
    nomePersonagem.innerText = personagem.getAttribute('data-name');
}

function alterarImagemDoPersonagemGrande(personagem, imagemPersonagemGrande) {
